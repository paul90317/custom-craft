...
item replace block ~ ~ ~ container.14 with minecraft:light_blue_dye{eg:{is:1b,type:label},'display':{'Name':'{"text":"Craft !","color":"light_purple"}','Lore':[]},'CustomModelData':1502} 1
