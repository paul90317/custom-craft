...
item replace block ~ ~ ~ container.26 with minecraft:light_blue_dye{eg:{is:1b,type:label},'display':{'Name':'{"text":"Close","color":"red","italic":false}','Lore':[]},'CustomModelData':1505} 1
