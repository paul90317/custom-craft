...
item replace block ~ ~ ~ container.14 with minecraft:clay_ball{eg:{is:1b,type:label},'display':{'Name':'{"text":"Scribe !","italic":false,"color":"yellow"}','Lore':[]},'CustomModelData':1501} 1
