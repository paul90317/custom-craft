...
execute if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:barrel"}] run scoreboard players add @s bp.temp 1
...
execute if score @s bp.temp matches 9 run function backpack:recipe/backpack/do
