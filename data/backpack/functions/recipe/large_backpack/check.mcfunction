...
execute if data block ~ ~ ~ Items[{Slot:11b,tag:{eg:{name:big_backpack}}}] run scoreboard players add @s bp.temp 1
...
execute if score @s bp.temp matches 9 run function backpack:recipe/large_backpack/do
